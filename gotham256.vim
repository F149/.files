...
call s:Col('PmenuSel', 'white', 'blood')
...
call s:Col('StatusLine', 'white', 'base2')
call s:Col('WildMenu', 'base7', 'blood')

" The 'Hit ENTER to continue prompt'.
"call s:Col('Question', 'green')
call s:Col('Question', 'red2')
...
call s:Col('CtrlPNoEntries', 'base7', 'blood') " no entries
"call s:Col('CtrlPMatch', 'green')               " matching part
call s:Col('CtrlPMatch', 'gold2')               " matching part
"call s:Col('CtrlPPrtBase', 'white')             " '>>>' prompt
call s:Col('CtrlPPrtBase', 'white')             " '>>>' prompt
