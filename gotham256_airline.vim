...
let s:c.white   = { 'gui': '#f0f2cc', 'cterm': 230 }
let s:c.red2    = { 'gui': '#AA0505', 'cterm': 124 }
let s:c.blood   = { 'gui': '#6A0C0B', 'cterm': 124 }
let s:c.gold    = { 'gui': '#FBCA03', 'cterm': 166 }
let s:c.gold2   = { 'gui': '#ff9f1b', 'cterm': 166 }
let s:c.yellow2 = { 'gui': '#B97D10', 'cterm': 214 }
...
let s:CP3 = s:Array('white', 'blood', 'bold')
